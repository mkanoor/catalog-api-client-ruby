...
# Unit tests for CatalogApiClient::ApprovalRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApprovalRequest' do
  before do
    # run before each test
    @instance = CatalogApiClient::ApprovalRequest.new
  end
  ...
  describe 'test an instance of ApprovalRequest' do
    it 'should create an instance of ApprovalRequest' do
      expect(@instance).to be_instance_of(CatalogApiClient::ApprovalRequest)
    end
  end
