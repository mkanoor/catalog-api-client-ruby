...
# Unit tests for CatalogApiClient::ImportServicePlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ImportServicePlan' do
  before do
    # run before each test
    @instance = CatalogApiClient::ImportServicePlan.new
  end
  ...
  describe 'test an instance of ImportServicePlan' do
    it 'should create an instance of ImportServicePlan' do
      expect(@instance).to be_instance_of(CatalogApiClient::ImportServicePlan)
    end
  end
