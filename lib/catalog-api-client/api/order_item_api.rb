  ...
  class OrderItemApi
    ...
    def destroy_order_item_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling OrderItemApi.destroy_order_item, must conform to the pattern /^\d+$/."
      end

      # resource path
      local_var_path = '/order_items/{id}'.sub('{' + 'id' + '}', id.to_s)
    ...
    def list_approval_requests_with_http_info(order_item_id, opts = {})
      ...
      if @api_client.config.client_side_validation && order_item_id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'order_item_id' when calling OrderItemApi.list_approval_requests, must conform to the pattern /^\d+$/."
      end
    ...
    def list_progress_messages_with_http_info(order_item_id, opts = {})
      ...
      if @api_client.config.client_side_validation && order_item_id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'order_item_id' when calling OrderItemApi.list_progress_messages, must conform to the pattern /^\d+$/."
      end
    ...
    def restore_order_item_with_http_info(id, restore_key, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling OrderItemApi.restore_order_item, must conform to the pattern /^\d+$/."
      end
      ...
      # resource path
      local_var_path = '/order_items/{id}/restore'.sub('{' + 'id' + '}', id.to_s)
    ...
    def show_order_item_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id !~ Regexp.new(/^\d+$/)
        fail ArgumentError, "invalid value for 'id' when calling OrderItemApi.show_order_item, must conform to the pattern /^\d+$/."
      end
