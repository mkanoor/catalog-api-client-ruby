...
module CatalogApiClient
  class PortfolioApi
    ...
    # @return [Array<Tag>]
    def add_portfolio_tag(id, tag, opts = {})
      data, _status_code, _headers = add_portfolio_tag_with_http_info(id, tag, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def remove_portfolio_tags(id, tag, opts = {})
      remove_portfolio_tags_with_http_info(id, tag, opts)
      nil
    end
    ...
    def show_portfolio_icon(portfolio_id, opts = {})
      data, _status_code, _headers = show_portfolio_icon_with_http_info(portfolio_id, opts)
      data
    end
