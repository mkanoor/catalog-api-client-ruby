...
module CatalogApiClient
  class PortfolioItemApi
    ...
    # @return [Array<Tag>]
    def add_portfolio_item_tag(id, tag, opts = {})
      data, _status_code, _headers = add_portfolio_item_tag_with_http_info(id, tag, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def remove_portfolio_item_tags(id, tag, opts = {})
      remove_portfolio_item_tags_with_http_info(id, tag, opts)
      nil
    end
    ...
    def show_portfolio_item_icon(portfolio_item_id, opts = {})
      data, _status_code, _headers = show_portfolio_item_icon_with_http_info(portfolio_item_id, opts)
      data
    end
    ...
    def show_portfolio_item_icon_with_http_info(portfolio_item_id, opts = {})
      ...
      header_params = opts[:header_params] || {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['image/svg+xml', 'image/png', 'image/jpeg'])
