...
module CatalogApiClient
  class OrderItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'service_parameters')
        self.service_parameters = attributes[:'service_parameters']
      end

      if attributes.has_key?(:'provider_control_parameters')
        self.provider_control_parameters = attributes[:'provider_control_parameters']
      end

      if attributes.has_key?(:'service_plan_ref')
    ...
    def hash
      [id, count, service_parameters, provider_control_parameters, service_plan_ref, portfolio_item_id, state, created_at, ordered_at, completed_at, updated_at, owner].hash
    end
